...
// Official UofL Cardinals logo via ESPN CDN (Louisville NCAA ID: 97)
const LOGO_URL = 'https://a.espncdn.com/i/teamlogos/ncaa/500/97.png'

export default function CardinalLogo({ size = 48, className = '' }: Props) {
  const [failed, setFailed] = useState(false)

  if (failed) {
    // SVG fallback if CDN is unreachable
    return (
